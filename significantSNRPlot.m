function z = significantSNRPlot(cond, conditions_to_visualize, groups_to_visualize, target_freq, file_name)
...
if(signal_index == 1)
    ...
    fig = figure()
    plot(orientation, mean_low)
    hold on
    plot(orientation, mean_medium)
    plot(orientation, mean_high)
    plot(orientation, mean_average)
    ylim([miny maxy])
